...
MTS_VARIANT
typename Scene<Float, Spectrum>::PositionSample3f
Scene<Float, Spectrum>::sample_hidden_geometry_position(
    const Interaction3f &ref, const Point2f &sample_, Mask active) const {
...
MTS_VARIANT Float Scene<Float, Spectrum>::pdf_hidden_geometry_position(
